        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              We deliver exceptional web development, digital marketing, and business consulting 
              services that drive real results for companies of all sizes.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="#case-studies" className="text-gray-300 hover:text-primary-400 transition-colors">
                  Case Studies
                </Link>
              </li>
              <li>
                <Link href="#testimonials" className="text-gray-300 hover:text-primary-400 transition-colors">
                  Testimonials
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <span className="text-gray-300">Business Consulting</span>
              </li>
              <li>
